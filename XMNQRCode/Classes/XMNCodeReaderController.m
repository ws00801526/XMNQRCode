...
+ (void)load {
    ...
    kXMNQRCodeBundle = [NSBundle bundleForClass:[XMNCodeReaderController class]];
}
...
- (UIButton *)switchCameraButton {
    ...
    if (!_switchCameraButton) {
        ...
        [_switchCameraButton setImage:[UIImage imageWithContentsOfFile:[kXMNQRCodeBundle pathForResource:onImageName ofType:@"png"]] forState:UIControlStateNormal];
...
- (UIButton *)switchFlashButton {
    ...
    if (!_switchFlashButton) {
        ...
        [_switchFlashButton setImage:[UIImage imageWithContentsOfFile:[kXMNQRCodeBundle pathForResource:onImageName ofType:@"png"]] forState:UIControlStateNormal];
        [_switchFlashButton setImage:[UIImage imageWithContentsOfFile:[kXMNQRCodeBundle pathForResource:offImageName ofType:@"png"]] forState:UIControlStateSelected];
        [_switchFlashButton setImage:[UIImage imageWithContentsOfFile:[kXMNQRCodeBundle pathForResource:offImageName ofType:@"png"]] forState:UIControlStateHighlighted];
